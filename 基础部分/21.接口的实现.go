...
// 实现了接口中的Sing和GetName方法，那么Chicken和Tiger就属于该接口类型。
...
func Function(a AnimalInterface) { // 任何实现了该接口的类型，都能传入这个函数。该函数用于使用接口中的方法。
	a.Sing()
...
空接口：interface{}  任何类型都实现了这个接口。成为了万能类型
func myFunc(a interface{}){
    该函数可以接受任意类型。同时，可以使用断言，判断传入的类型
}
*/
